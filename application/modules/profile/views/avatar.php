...
<?php
    ...
    {
        $profile_pic_url = content_url('profile/'.$this->session->userdata('profile_pic'));
    }
?>
        ...
        <div class="pl-0">
            <div class="main-profile-overview">
                <div class="main-img-user profile-user">
                    <img alt="<?php echo $this->session->userdata('full_name'); ?>" src="<?php echo $profile_pic_url; ?>" id="avatar">
                ...
                <h5 class="main-profile-name"><?php echo $this->session->userdata('full_name'); ?></h5>
            </div>
        </div>
    </div>
</div>
