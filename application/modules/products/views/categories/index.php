...
<script type="text/javascript">
    ...
    category_select_box(category_url, '', '', 'multiple');
    ...
    function initTable() {
        $('#dataTableId').bootstrapTable({
            url: base_url+'<?php echo product_constants::get_product_categories_url; ?>',
            method: 'GET',                
            ...
            showColumns: true,
            detailView: false,
            exportOptions: { ignoreColumn: ['action'], fileName: 'Product Categories' },
            showExport: true,
            exportDataType: 'all',
