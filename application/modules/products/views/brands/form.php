                ...
                <form id="formId" class="" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row row-sm">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Brand Name <span class="asterisk">*</span></label>
                    ...
                    <div class="row row-sm">
                        <div class="col-12 mg-t-10">
                            ...
                            <a href="<?php echo base_url(product_constants::product_brands_url); ?>" class="btn btn-secondary custom-btn-secondary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
