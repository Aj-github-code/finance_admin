<?php
    ...
    class Genealogy_model extends CI_Model
    {
        ...
        function get_data($conditions, $limit, $offset, $allcount)
        {
            ...
            $sql_query="select uo.ownid,ud.firstname,ud.lastname,ud.midname,uo.status,uo.sponsorid,uo.`date`,uo.createddate,uo.pin,uo.pin_date from useroption uo,userdetails ud  where uo.ownid=ud.ownid and ".$where." and uo.ownid in (".$query_string.") order by ".$order." limit 10";
