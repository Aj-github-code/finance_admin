<?php
    ...
    class Binary_tree extends MY_Controller {
        ...
        function get_left_right($userid)
        {
            ...
            if(count($rowlevel11)>0){

                $lt11                           = isset($rowlevel11['leftmember']) ? $rowlevel11['leftmember'] : 'NA';
                $rt11                           = isset($rowlevel11['rightmember']) ? $rowlevel11['rightmember'] : 'NA';
    
                $rowlevel21                     = $this->binary->get_data($lt11);
                $lt21                           = isset($rowlevel21['leftmember']) ? $rowlevel21['leftmember'] : 'NA';
                $rt21                           = isset($rowlevel21['rightmember']) ? $rowlevel21['rightmember'] : 'NA';
    
                $rowlevel22                     = $this->binary->get_data($rt11);
                $lt22                           = isset($rowlevel22['leftmember']) ? $rowlevel22['leftmember'] : 'NA';
                $rt22                           = isset($rowlevel22['rightmember']) ? $rowlevel22['rightmember'] : 'NA';
        ...
        function check_left_right($userid)
        {
            ...
            if(($check['rt11'] == 'NA') && ($check['lt11'] == 'NA'))
            {
