    ...
    <div class="main-signin-wrapper">
        <div class="main-card-signin d-md-flex wd-100p">
            ...
            <div class="p-4 wd-md-50p">
                ...
                <?php /* ?><div class="main-signin-footer mt-3 mg-t-5">
                    <p>
                        <a href="<?php echo base_url(forgot_password_constants::forgot_password_url); ?>" class="float-right">Forgot password?</a>
                    </p>
                </div><?php */ ?>
            </div>
        </div>
